...
# from dataset.wsi_dataset import Wsi_Region
...
def pt2graph(wsi_h5, radius=9):
    ...
    coords, features = np.array(wsi_h5['coords']), np.array(wsi_h5['features']).squeeze()
...
def createDir_h5toPyG(h5_path, save_path):
    ...
    for h5_fname in pbar:
        ...
        try:
            ...
            pbar.set_description('%s - Broken H5' % (h5_fname[:-3]))
            print(h5_fname, 'Broken')

h5_path = r"G:\test\x00\h5_files"
save_path = r"G:\test\x00\graph_files"
